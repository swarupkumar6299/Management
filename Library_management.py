...
class LibraryManagementSystem:
    def __init__(self,root):
        ...
        def selectBook(event=""):
            ...
            if selected_indices:
                ...
                if x == "Design Analysis and Algorithm":
                ...
                if x == "Programing Problem Solving":
                ...
                if x == "Computer Orginazation and Architecture":
    ...
    def adda_data(self):
            conn = mysql.connector.connect(host="localhost",username="root",password="Swarup@0204",database="mydata")            
    ...
    def update(self):
        conn = mysql.connector.connect(host="localhost",username="root",password="Swarup@0204",database="mydata")            
        my_cursor=conn.cursor()
        my_cursor.execute("update library set Member=%s,Title=%s,FirstName=%s,LastName=%s,Address1=%s,Address2=%s,PostCode=%s,MobileNo=%s,BookID=%s,BookTitle=%s,Author=%s,DateBorrowed=%s,DateDue=%s,ActualPrice=%s,DaysOnBook=%s,LateReturnFine=%s,DateOverDue=%s where PRN_No=%s",(
    ...
    def showData(self):
        self.textbox.insert(END,"Member Type:\t\t"+ self.member_var()+"\n")
        self.textbox.insert(END,"PRN NO:\t\t"+ self.prn_var()+"\n")
        self.textbox.insert(END,"Title:\t\t"+ self.title_var()+"\n")
        self.textbox.insert(END,"First Name :\t\t"+ self.firstname_var()+"\n")
        self.textbox.insert(END,"Last Name:\t\t"+ self.lastname_var()+"\n")
        self.textbox.insert(END,"Address1:\t\t"+ self.address1_var()+"\n")
        self.textbox.insert(END,"Address2:\t\t"+ self.address2_var()+"\n")
        self.textbox.insert(END,"Postcode:\t\t"+ self.postcode_var()+"\n")
        self.textbox.insert(END,"mobile:\t\t"+ self.mobile_var()+"\n")
        self.textbox.insert(END,"Book id:\t\t"+ self.bookid_var()+"\n")
        self.textbox.insert(END,"book Title:\t\t"+ self.booktitle_var()+"\n")
        self.textbox.insert(END,"Author:\t\t"+ self.author_var()+"\n")
        self.textbox.insert(END,"Date Borrowed:\t\t"+ self.datedue_var()+"\n")
        self.textbox.insert(END,"Date Due:\t\t"+ self.member_var()+"\n")
        self.textbox.insert(END,"Days on Book:\t\t"+ self.daysonbook_var()+"\n")
        self.textbox.insert(END,"Late Return Fine:\t\t"+ self.latereturn_var()+"\n")
        self.textbox.insert(END,"date Borrowed:\t\t"+ self.dateoverdue_var()+"\n")
        self.textbox.insert(END,"Actual price:\t\t"+ self.actualprice_var()+"\n")
